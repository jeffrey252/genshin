    ...
    <div>
      <div className="card">
        ...
        <div className="card-body">
          <Button href="/characters/create/" variant="outline-primary">
            Create Character
          </Button>
          &nbsp;{" "}
          <Button href="/characters/talentMaterials/" variant="outline-primary">
            Manage Talent Materials
          </Button>
          <br />
          <br />
              ...
              {characters &&
                characters.map((character) => (
                  <tr key={character.id}>
                    ...
                    <td>
                      {character.talent_material.name} ({" "}
                      {character.talent_material.schedule.name} ){" "}
                    </td>
                    <td>
                      <Button
                        href={`${path}/edit/${character.id}`}
                        variant="dark"
                      >
                        Edit
                      </Button>
