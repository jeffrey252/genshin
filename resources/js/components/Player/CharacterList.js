        ...
        <div>
            <div className='card'>
                ...
                <div className='col-md-8'>
                    ...
                    />
                    <br />
                    <Button onClick={addCharacter} variant="primary">Add Character</Button>
                </div>
                    <br />
                    <br />
                    <table className='table'>
                        ...
                        <tbody>
                            {playerCharacters && playerCharacters.map(
                                character => (
                                    <tr key={character.id}>
                                        <td>{character.name}</td>
                                        <td>
                                            <Button data-character-id={character.id} onClick={handleDelete} variant="danger">Delete</Button>
                                        </td>
                                    </tr>
                                )
                            )}
